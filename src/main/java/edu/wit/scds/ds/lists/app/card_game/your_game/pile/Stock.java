...
// @formatter:off
// you might modify this code - talk to me if you have any questions
...
public final class Stock
    ...
    public static void main( final String[] args )
        ...
        cardSource.moveCardsToBottom( myStock.removeAllMatchingCards( newCardLike( JOKER,
                                                                                   Suit.NA ) ) ) ;

        // let's see what's in each pile
        System.out.printf( "deck: %s%n",
                           cardSource.revealAll()
                                     .toString() ) ;
        System.out.printf( "stock: %s%n",
                           myStock.revealAll()
                                  .toString() ) ;
        ...
        try
            ...
            myStock.addToTop( newCardLike( JOKER,
                                           Suit.NA ) ) ;
