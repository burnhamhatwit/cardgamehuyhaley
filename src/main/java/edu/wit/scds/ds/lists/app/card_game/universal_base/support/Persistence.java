...
/**
 * Represents the persistence of a {@code Card} (permanent or temporary). It is used to distinguish between
 * cards created by a deck (permanent) and those used for lookup/matching (temporary). This also provides
 * support for filtering cards when they are added to a pile.
 *
 * @author David M Rosenberg
 *
 * @version 1.0 2025-07-12 Initial implementation - extracted from {@code UniversalBaseCard}
 * @version 1.1 2025-11-19 add {@code TEMPLATE} to support enhanced functionality when instantiating a Deck or
 *     verifying that it is complete at the end of a game
 */
