...
// @formatter:off
// NOTE you might modify this code - talk to me if you have any questions
...
public final class Player
    ...
    public Card playACard( final Rank rank,
        ...
        return playACard( newCardLike( rank,
                                       suit ) ) ;
    ...
    public static void main( final String[] args )
        ...
        // CHALLENGE what's the efficiency of moving all the jokers? CHALLENGE can it be O(1)? if so, how?
        ...
        System.out.printf( "%nwith some melds: %s%n",
                           testPlayer ) ;
