...
/**
 * Represents the orientation of a {@code Card} (face up or face down). When a {@code Card} is face up, its
 * designation (for example, "A♦") is visible and will be displayed. When face down, a placeholder designation
 * is displayed (for example, "--").
 *
 * @author David M Rosenberg
 *
 * @version 1.0 2025-06-26 Initial implementation - replaces boolean constants for face up/down specification
