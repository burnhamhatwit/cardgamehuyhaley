 ...
 *     <li>revise {@code interpretDescription} to select based on abbreviated name rather than hardcoded
 *     values
 ...
 *     <ul>
 *     <li>rename from {@code CardRank} to {@code Rank} to track other class changes
 *     <li>swap (alt) point and (alt) order values
 *     </ul>
 * @version 7.1 2026-03-30 add 'not applicable' to support games that only care about suit
 */
public enum Rank
    {
...
//  Element     Display Name  Abbreviation  Graphic     Points   Alt Points      Order    Alt Order
    ...
    , /** no rank - placeholder for matching on suit only */
    NA      (   "",             "N",          "",          0,         0,           0,         0 )
    ;
// @formatter:on
    ...
    public static void main( final String[] args )
        ...
        System.out.printf( "%-5s %-8s %-8s %-12s   %-12s %-15s %-6s   %-10s   %-10s %-15s%n",
                           "#",
                           "Rank",
                           "Graphic",
                           "Abbreviation",
        ...
        Arrays.asList( Rank.values() )
              .forEach( aRank ->
                  ...
                  System.out.printf( "%,-5d  %2s         %2s          %-6s   %-12s %-15s   %,2d        %,2d         %,2d           %,2d%n",
                                     aRank.ordinal(),
                                     aRank,
                                     aRank.graphic,
                                     aRank.abbreviatedName,
