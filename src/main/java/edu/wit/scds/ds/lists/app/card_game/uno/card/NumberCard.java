...
public final class NumberCard
     ...
     *     this card's color
     */
    public NumberCard( final CardColor theColor,
        ...
        if ( theValue.getKind() != Kind.NUMBER )
            {
     ...
     *     the card to copy
     */
    public NumberCard( final NumberCard sourceCard )
        {
    ...
    public static void main( final String[] args )
        ...
        for ( final CardValue value : values )
            ...
            // only create number cards
            if ( value.getKind() != Kind.NUMBER )
                {
            ...
            for ( final CardColor color : value.getColors() )
                ...
                for ( int i = 1 ; i <= value.getQuantity() ; i++ )
                    ...
                    final Card newCard = new NumberCard( color,
                                                         value ) ;
                    System.out.printf( " %s",
                                       newCard ) ;
        ...
        card1 = new NumberCard( CardColor.BLUE,
                                CardValue.FOUR ) ;
        card2 = new NumberCard( CardColor.YELLOW,
                                CardValue.FOUR ) ;
        System.out.printf( "%s.equals(%s) = %b (value and color)%n",
                           card1,
                           card2,
        ...
        CardBase.setDefaultOrientation( FACE_UP ) ;
        card1 = new NumberCard( CardColor.GREEN,
                                CardValue.FOUR ) ;
        card2 = new NumberCard( CardColor.BLUE,
                                CardValue.FOUR ) ;
        System.out.printf( "%s.matches(%s) = %b (value and color)%n",
                           card1,
                           card2,
        ...
        card1 = new NumberCard( CardColor.ANY,
                                CardValue.FIVE ) ;
        card2 = new NumberCard( CardColor.BLUE,
                                CardValue.FIVE ) ;
