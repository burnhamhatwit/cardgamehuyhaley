 ...
 * @version 2.2 2026-03-26 add factory for a temporary, limited-purpose collection of {@code Card}s to
...
public abstract class Pile
    ...
    public Card getCardLike( final Rank rank,
        ...
        return getCardLike( newCardLike( rank,
                                         suit ) ) ;
    ...
    public Card removeCard( final Rank rank,
        ...
        return removeCard( newCardLike( rank,
                                        suit ) ) ;
