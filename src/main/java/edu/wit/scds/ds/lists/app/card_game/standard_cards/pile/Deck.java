 ...
 *     </ul>
 * @version 1.3 2026-03-30 ignore both rank and suit of NA
 */
public final class Deck
    ...
    private void createTemplateCards()
        ...
        for ( final Suit suit : suits )
            ...
            for ( final Rank rank : ranks )
                ...
                if ( (rank == Rank.NA ) || ( rank == Rank.JOKER ) )
                    {
                ...
                super.cards.add( newCardLike( rank,
                                              suit ) ) ;
    ...
    public static void main( final String[] args )
        ...
        final Card testCard = newCardLike( Rank.ACE,
                                           Suit.DIAMONDS ).reveal() ;
        ...
        try
            ...
            final Persistence savedPersistence = CardBase.setDefaultPersistence( Persistence.PERMANENT ) ;
            final Card extraCard = newCardLike( Rank.SEVEN,
                                                Suit.DIAMONDS ).reveal() ;
            CardBase.setDefaultPersistence( savedPersistence ) ;
